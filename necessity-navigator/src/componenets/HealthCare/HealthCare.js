        ...
        <div className='back_img' >
            <div className="medical-services">
                <div className="content">
                    <h1>Get Quick <span>Medical Information</span></h1>
                    <p>Welcome to healthcare, your comprehensive source for reliable medical services and healthcare information. Whether you are looking for expert medical professionals or convenient pharmacy locations, We got you covered. </p>
                    <button className="get-services-button">Get Services</button>
                </div>
                <div className="doctor-info">
                    <img src="https://th.bing.com/th/id/OIP.lkXb557anCMib84o0SKmsQHaHa?rs=1&pid=ImgDetMain" alt="Doctor" className="doctor-image" />
                    <div className="info-box clients">
                        <span>1520+</span>
                        <p>Active Clients</p>
                    </div>
                    <div className="info-box offer">
                        <p>Get 20% off for 1st month</p>
                        <p>Expert Doctors</p>
                    </div>
                </div>
            </div>
            ...
            <div className="suggested-facility-container-row">
                <h1>Suggested Facilities</h1>
                <div className='suggested-facility-container'>
